...
import 'package:trial/core/constants/urls.dart';
import 'package:trial/core/extensions/build_context_extensions.dart';
import 'package:trial/core/extensions/string_extensions.dart';
...
class _FeaturesList extends StatelessWidget {
  ...
  final _features = [
    _Feature(
        ...
        description:
            "Feature-first approach with domain, data and presentation layers."),
    _Feature(
        title: "Dependency injection",
        description: "Implemented using GetIt and Injectable."),
    ...
    _Feature(
        ...
        description: "Login with magic link and logout."),
    _Feature(
        title: "Settings page",
        description:
            "Change email address, privacy policy, terms of service, app info."),
            ...
            Column(
              children: _features
                  .map((feature) => ListTile(
                        ...
                        subtitle: !feature.description.isNullOrEmpty
